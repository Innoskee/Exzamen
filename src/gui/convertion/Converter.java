...
public class Converter {
     ...
     */
    public static int xCrt2Scr(double x, CartScreenPlane plane) {
     ...
     */
    public static double xScr2Crt(double x, CartScreenPlane plane) {
        var px = plane.getXDen();
     ...
     */
    public static int yCrt2Scr(double y, CartScreenPlane plane) {
     ...
     */
    public static double yScr2Crt(double y, CartScreenPlane plane) {
        var py = plane.getYDen();
